...
const translations = {
  it: {
    ...
    digitalText1: "Considero gli strumenti digitali e le pratiche di making come estensioni dello stesso processo di progettazione. Lo spazio digitale è un ambiente in cui testare le regole di un sistema, non solo un attrezzo per la rappresentazione.",
