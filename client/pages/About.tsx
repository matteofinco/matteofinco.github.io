...
const translations = {
  it: {
    ...
    digitalText1: "Considero modellazione digitale e prototipazione fisica come due parti dello stesso processo. Passo continuamente dal modello CAD all'oggetto reale: stampa 3D, lavorazioni meccaniche e costruzione manuale diventano strumenti per verificare idee, individuare problemi e migliorare il progetto..",
    digitalText2: "Credo che un progetto debba essere anche costruito per essere realmente compreso. Per questo alterno progettazione digitale e sperimentazione fisica, trasformando modelli CAD, stampe 3D e prototipi in strumenti per esplorare possibilità, errori e nuove soluzioni.",
  ...
  en: {
    ...
    digitalText1: "I consider digital modelling and physical prototyping as two parts of the same process. I constantly move between CAD models and physical objects: 3D printing, mechanical processes and hands-on fabrication become tools to test ideas, identify problems and improve the design.",
    digitalText2: "I believe a project needs to be built in order to be truly understood. This is why I alternate digital design and physical experimentation, turning CAD models, 3D prints and prototypes into tools to explore possibilities, mistakes and new solutions.",
