...
export default function CV() {
  ...
  // Stati per il caricamento on-demand degli iframe
  ...
  // Rileva lo schermo mobile e forza l'inglese per layout pulito
  useEffect(() => {
    const handleResize = () => {
  ...
  // Gestione caricamenti differiti per performance fluide
  useEffect(() => {
  ...
  return (
    <div className="bg-[#070707] text-[#e5e5e5] flex flex-col h-screen w-screen overflow-hidden m-0 p-0 relative">
      ...
      <main style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", width: "100%", margin: 0, padding: 0, position: "relative", paddingTop: "70px" }}>
        ...
        <div style={{ 
          ...
          {isMobile ? (
            ...
            <div style={{
              ...
              {/* RETTANGOLI DI COPERTURA LATERALI (Scuriti a #070707) */}
              {/* Sinistro */}
              <div style={{
                position: "absolute",
                top: 0,
        ...
        {/* BARRA INFERIORE (Opaca / Dark Glass) */}
        <div 
          style={{
            position: "absolute",
            bottom: "0px",
